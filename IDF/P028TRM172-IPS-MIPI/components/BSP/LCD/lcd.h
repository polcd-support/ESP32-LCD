...
void lcd_set_back_color(uint16_t color);                                                        /* 设置文字背景色 */
...
void lcd_draw_rgb565_bitmap(uint16_t x, uint16_t y, uint16_t width, uint16_t height, const uint16_t *data); /* 显示RGB565图片 */
