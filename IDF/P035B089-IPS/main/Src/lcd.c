...
static const st7701_lcd_init_cmd_t lcd_init_cmds[] = {
    ...
    {0xC1, (uint8_t[]){0x14, 0x0C}, 2, 0},
    {0xC2, (uint8_t[]){0x37, 0x02}, 2, 0},
    {0xCC, (uint8_t[]){0x10}, 1, 0},
    {0xB0, (uint8_t[]){0x06,0x10,0x16,0x0D,0x11,0x06,0x08,0x07,0x08,0x22,0x04,0x14,0x0F,0x29,0x2F,0x1F}, 16, 0},
    {0xB1, (uint8_t[]){0x0F,0x18,0x1E,0x0C,0x0F,0x06,0x08,0x0A,0x09,0x24,0x05,0x10,0x11,0x2A,0x34,0x1F}, 16, 0},
    ...
    {0xE1, (uint8_t[]){0x06,0x28,0x08,0x28,0x05,0x28,0x07,0x28,0x0E,0x33,0x33}, 11, 0},
    {0xE2, (uint8_t[]){0x30,0x30,0x33,0x33,0x34,0x00,0x00,0x00,0x34,0x00,0x00,0x00}, 12, 0},
    {0xE3, (uint8_t[]){0x00, 0x00, 0x33, 0x33}, 4, 0},
    {0xE4, (uint8_t[]){0x44, 0x44}, 2, 0},
    {0xE5, (uint8_t[]){0x09,0x2F,0x2C,0x8C,0x0B,0x31,0x2C,0x8C,0x0D,0x33,0x2C,0x8C,0x0F,0x35,0x2C,0x8C}, 16, 0},
    {0xE6, (uint8_t[]){0x00, 0x00, 0x33, 0x33}, 4, 0},
    {0xE7, (uint8_t[]){0x44, 0x44}, 2, 0},
    {0xE8, (uint8_t[]){0x08,0x2E,0x2C,0x8C,0x0A,0x30,0x2C,0x8C,0x0C,0x32,0x2C,0x8C,0x0E,0x34,0x2C,0x8C}, 16, 0},
	{0xE9, (uint8_t[]){0x36, 0x00}, 2, 0},
    {0xEB, (uint8_t[]){0x00,0x01,0xE4,0xE4,0x44,0x88,0x40}, 7, 0},
    {0xED, (uint8_t[]){0xFF,0xFC,0xB2,0x45,0x67,0xFA,0x01,0xFF,0xFF,0x10,0xAF,0x76,0x54,0x2B,0xCF,0xFF}, 16, 0},
