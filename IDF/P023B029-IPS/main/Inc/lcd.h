...
#define EXAMPLE_LCD_IO_SPI_CS (GPIO_NUM_10)
#define EXAMPLE_LCD_IO_SPI_SCL (GPIO_NUM_47)
#define EXAMPLE_LCD_IO_SPI_SDA (GPIO_NUM_11)
...
#define EXAMPLE_LCD_IO_RST (GPIO_NUM_48)        // -1 if not used
...
#define EXAMPLE_HSYNC_PULSE_WIDTH 4                   // hpw 2
#define EXAMPLE_HSYNC_BACK_PORCH 26                   // hbp 8
#define EXAMPLE_HSYNC_FRONT_PORCH 24                  // hfp 40
#define EXAMPLE_VSYNC_PULSE_WIDTH 2                   // vpw 2
#define EXAMPLE_VSYNC_BACK_PORCH 28                   // vbp 8
